    ...
    <div className="row osahan-login m-0">
        ...
        <div className="col-md-6 d-flex justify-content-center flex-column px-0">
            <div className="col-lg-6 mx-auto">
                ...
                <p className="mb-5">Please create an account to continue using our service</p>
                <form>
                    <div className="d-flex align-items-center mb-4">
                        <div className="mr-3 bg-light rounded p-2 osahan-icon"><i className="mdi mdi-account-outline"></i></div>
                        <div className="w-100">
                            <p className="mb-0 small font-weight-bold text-dark">Full Name</p>
                            <input type="text" className="form-control form-control-sm p-0 border-input border-0 rounded-0" placeholder="Enter Your Name"  />
                        </div>
                    </div>
                    <div className="d-flex align-items-center mb-4">
                    ...
                    <div className="mb-3">
                        <a href="index.html" className="btn btn-primary btn-block mb-3">Create an account</a>
                        <p className="text-center">Already have an account? <a href="signin.html" className="text-danger text-decoration-none">Sign in</a></p>
                    </div>
                </form>
            </div>
        </div>
